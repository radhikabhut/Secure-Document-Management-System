...
func (_m *DashboardService) Stats(ctx context.Context) (dto.DashboardStatsResponse, error) {
	ret := _m.Called(ctx)
	...
	var r0 dto.DashboardStatsResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (dto.DashboardStatsResponse, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) dto.DashboardStatsResponse); ok {
		r0 = rf(ctx)
	} else {
		r0 = ret.Get(0).(dto.DashboardStatsResponse)
	}
